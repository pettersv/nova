...
class LibvirtDriver(driver.ComputeDriver):
	...
	#Petter
	qemu_commandline_args = instance['qemu_commandline'].split()
	for arg in qemu_commandline_args:
	    LOG.error('appending qemu_commandline arg: ',arg)
            guest.qemu_commandline.append(arg)
	    
	LOG.error('qemu_commandline:',guest.qemu_commandline)
	    ...
	    #Petter
            #LOG.error('TEST: injecting heca parameters')
            #guest.qemu_commandline.append('-heca')
            #guest.qemu_commandline.append('hspaceid=1,mode=master')
	    #guest.qemu_commandline.append('-hecamr')
	    #guest.qemu_commandline.append('start=0,size=1G,hprocids=1')
	    #guest.qemu_commandline.append('-hecaproc')
	    #guest.qemu_commandline.append('hprocid=1,ip=192.168.2.7,port=4444,tcp_port=4445')
	    #guest.qemu_commandline.append('-hecaproc')
            #guest.qemu_commandline.append('hprocid=2,ip=192.168.2.8,port=4444,tcp_port=4445')
